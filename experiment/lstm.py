...
# design network
model = Sequential()
model.add(LSTM(256, input_shape=(train_X.shape[1], train_X.shape[2]))) #32
#model.add(Dense(16))
model.add(Dense(1))
...
#test_yy_matrix = np.loadtxt(open("C:\\Users\\HP\Desktop\\实验\\流感疫情分析\\工作进展\\3_对比实验\\3_lstm\\test1\\test_yy.csv","rb"),delimiter=",")
#pre_yy_matrix = np.loadtxt(open("C:\\Users\\HP\Desktop\\实验\\流感疫情分析\\工作进展\\3_对比实验\\3_lstm\\test1\\pre_yy.csv","rb"),delimiter=",")
